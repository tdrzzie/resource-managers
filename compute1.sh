...
ssh root@management
cd 6.0.1
scp contrib/systemd/pbs_mom.service root@compute1:/usr/lib/systemd/system/
scp torque-package-mom-linux-x86_64.sh root@compute1:/opt
scp torque-package-clients-linux-x86_64.sh root@compute1:/opt
ssh root@compute1
